...
- [X] [InterviewBit Questions](https://www.interviewbit.com/courses/programming/topics/time-complexity/)
...
- ### Arrays
    ...
    - [ ] Implement a vector (mutable array with automatic resizing):
        ...
        - [ ] is_empty()
        - [X] index() - returns item at given index, blows up if index out of bounds
        - [X] append(item)
